...
class IFengNewsCrawler(BaseCrawler):
    def __init__(self):
        super().__init__()
        self.source_name = "凤凰新闻"
        self.api_url = "https://api.3g.ifeng.com/client_search_list?keyword=财经&page=1"
        self.enabled = True
        ...
        try:
            ...
            for item in data:
                news = {
                    ...
                    'pub_time': self.parse_datetime(item.get('timestamp', '')),
