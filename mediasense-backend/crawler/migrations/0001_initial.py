...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("task_id", models.CharField(default=uuid.uuid4, max_length=36, unique=True, verbose_name="任务ID")),
                (
                    "status",
                    models.IntegerField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["status", "-updated_at"], name="crawler_cra_status_d71a10_idx"),
        ),
        migrations.AddIndex(
            model_name="crawlerconfig",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["config", "-start_time"], name="crawler_cra_config__2c2005_idx"),
        ),
        migrations.AddIndex(
            model_name="crawlertask",
            index=models.Index(fields=["status", "-start_time"], name="crawler_cra_status_a980ea_idx"),
        ),
        migrations.AddIndex(
            model_name="crawlertask",
