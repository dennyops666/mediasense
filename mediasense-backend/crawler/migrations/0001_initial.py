    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-updated_at"],
                "indexes": [
                    models.Index(fields=["status", "-updated_at"], name="crawler_cra_status_d71a10_idx"),
                    models.Index(fields=["is_active", "-updated_at"], name="crawler_cra_is_acti_e79da7_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["is_test", "-start_time"], name="crawler_cra_is_test_35b1db_idx"),
                ],
            },
        ),
    ]
