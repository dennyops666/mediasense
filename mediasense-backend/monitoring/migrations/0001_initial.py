# Generated by Django 4.2.9 on 2025-01-29 11:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-timestamp"],
                "indexes": [
                    models.Index(fields=["metric_type", "timestamp"], name="monitoring__metric__641d8a_idx"),
                    models.Index(fields=["created_by"], name="monitoring__created_ad5770_idx"),
                ],
            },
        ),
        migrations.AddIndex(
